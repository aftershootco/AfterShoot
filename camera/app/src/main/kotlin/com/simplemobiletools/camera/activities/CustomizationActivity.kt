...
import com.simplemobiletools.camera.dialogs.LineColorPickerDialog
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun pickPrimaryColor() {
        curPrimaryLineColorPicker  = com.simplemobiletools.camera.dialogs.LineColorPickerDialog(this, curPrimaryColor, true, menu = menu) { wasPositivePressed, color ->
    ...
    private fun pickAppIconColor() {
        com.simplemobiletools.camera.dialogs.LineColorPickerDialog(this, curAppIconColor, false, R.array.md_app_icon_colors, getAppIconIDs()) { wasPositivePressed, color ->
            if (wasPositivePressed) {
